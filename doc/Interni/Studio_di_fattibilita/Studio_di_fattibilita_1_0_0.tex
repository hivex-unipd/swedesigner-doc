...
\section{Introduzione}
	...
	\subsection{Riferimenti}
		...
		\begin{itemize}
			...
			\item \textbf{Capitolato d'Appalto C1}, \emph{APIM}: An \gloss{API} Market Platform \\
			...
			\item \textbf{Capitolato d'Appalto C6}, \emph{SWEDesigner}: \gloss{editor} di diagrammi \gloss{UML} con generazione di codice \\
...
\section{Studio di fattibilità del capitolato scelto}
	\subsection{\proj: editor di diagrammi UML con generazione di codice}
		...
		ed un coordinatore, che permetta all'utente di costruire diagrammi UML rappresentativi del prodotto da svilupparsi e generi a partire da essi codice \gloss{Java} o \gloss{JavaScript}.
		
		In particolare l'editor dovrebbe concentrarsi su uno specifico dominio applicativo (l'esempio fornito nel capitolato d'appalto è relativo ai software di giochi da tavolo) per andare a costituire una sorta di \gloss{framework} per la produzione della relativa famiglia di prodotti.
		...
		\subsubsection{Studio del dominio}
			...
			Il capitolato richiede che il sistema sia realizzato con tecnologie Web. In particolare la parte \gloss{server} deve essere realizzata in Java con il server 
			\gloss{Tomcat} o in Javascript con il server \gloss{Node.js}. La parte \gloss{client}, invece, deve essere eseguibile in un browser \gloss{HTML5} ed utilizzare fogli di stile \gloss{CSS} per 
...
\section{Studio di fattibilità degli altri capitolati}
	\subsection{Capitolato C1: \emph{APIM}: An API Market Platform}
		\subsubsection{Descrizione}
		Lo scopo di questo capitolato è quello di creare un'applicazione web che rappresenti una sorta di \gloss{marketplace} per la consultazione e 
		...
		\subsubsection{Studio del dominio}
			...
			\begin{itemize}
			\item di sviluppare il front end della web application con l'ausilio della terna JavaScript, \gloss{HTML} e \gloss{CSS3};
	...
	\subsection{Capitolato C2: \emph{AtAVi}: Accoglienza tramite Assistente Virtuale}
		...
		\begin{itemize}
			...
			\item un sistema che sfrutti gli \gloss{AWS} per l'interazione con le API dell'assistente virtuale scelto.
		\end{itemize}
		...
		\subsubsection{Studio del dominio}
			...
			\begin{itemize}
				\item i servizi offerti dall'\gloss{infrastruttura} degli AWS;
	...
	\subsection{Capitolato C3: \emph{DeGeOP}: A Designer and Geo-localizer Web App for Organizational Plants}
		...
		\subsubsection{Studio del dominio}
			...
			\begin{itemize}
				...
				\item \gloss{Django}, come framework in \gloss{Python} per la realizzazione del front-end dell'applicativo;
				\item \gloss{PostgreSQL}, per la realizzazione del database di appoggio del software;
				\item Librerie e framework quali \gloss{Bootstrap} e \gloss{React.js} per la creazione di interfacce utente, \gloss{hammer.js} e Yeoman;
	...
	\subsection{Capitolato C5: \emph{Monolith}: an interactive bubble provider}
		...
		\subsubsection{Studio del dominio}
			...
			\begin{itemize}
				...
				\item framework quali \gloss{Angular.js} e React.js sono consigliati per la realizzazione del front-end dell'applicazione;
