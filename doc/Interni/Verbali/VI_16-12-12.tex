...
\item per la gestione automatizzata dei requisiti, ci è venuta in aiuto un'interfaccia open-source \gloss{PHP}/My\gloss{\gloss{SQL}} chiamata “\gloss{PragmaDB}”, ideata da alcuni nostri predecessori;
\item analizzato alcuni software per il controllo del codice e dei documenti quali \gloss{Sonarqube} e \gloss{Travis} che si integra bene con \gloss{Github}, e altre tecnologie circa \gloss{java}, \gloss{javascript}, \gloss{javaDoc} ed infine IntelliJIDEA;
