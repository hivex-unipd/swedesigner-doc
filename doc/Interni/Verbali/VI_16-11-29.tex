...
\begin{itemize}
\item il nome e il logo del gruppo e dopo varie proposte abbiamo scelto all'unanimità il nome \emph{Hivex}, dall'inglese \emph{hive} (la casetta delle \gloss{api}), dato che il nostro gruppo si compone di sei persone --- tante quanti i lati dell'esagono; inoltre Francis Bacon scriveva, nel \emph{Novum Organum},
\begin{quote}
