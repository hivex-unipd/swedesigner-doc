...
Decisioni prese:
\begin{itemize}
\item abbiamo appurato che il dominio di programmi software che il nostro \gloss{editor} dovrà modellare dev'essere mirato ad un particolare ambiente applicativo; 
\item linguaggio da usare e natura del software (\gloss{applicazione web} o desktop) liberi.
\end{itemize}
\end{document}
