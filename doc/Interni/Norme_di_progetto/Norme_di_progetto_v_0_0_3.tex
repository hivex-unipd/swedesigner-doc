...
Per gestire la \gloss{documentazione} di progetto si è pensato, innanzitutto, di creare un \gloss{branch} a parte (intitolato \texttt{doc}) a partire dal branch \texttt{master} del nostro \gloss{repository}; questa scelta è stata dettata dal basso grado di dipendenza tra la documentazione e il resto delle parti della \gloss{configurazione} del prodotto. I documenti che svilupperemo sono i seguenti:
\begin{itemize}
...
\subsection{Configurazione} \dots
