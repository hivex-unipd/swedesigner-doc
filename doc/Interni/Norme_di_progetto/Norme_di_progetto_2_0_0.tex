...
\begin{longtable}{|p{0.3\textwidth}|p{0.4\textwidth}|p{0.3\textwidth}|}
	...
	\hline
	\endhead 
	Branch Coverage & Il range di accettazione stabilito per la metrica è 80 - 100 & La misura viene effettuata utilizzando lo strumento Travis CI \\ 
	\hline 
	Budget Variance & Il range di accettazione stabilito per la metrica è -25 - 0 & La misura viene effettuata utilizzando lo strumento Asana \\ 
	\hline 
	Complessità ciclomatica per metodo & Il range di accettazione stabilito per la metrica è 0 - 10 & La misura viene effettuata utilizzando lo strumento CodePro Analytix \\ 
	\hline 
	Copertura requisiti desiderabili & Il range di accettazione stabilito per la metrica è 50 - 100 & La misura viene effettuata prendendo in considerazione le informazioni aggiornate nel database di PragmaDB a seguito dell'esecuzione con successo dei relativi test di sistema \\ 
	\hline 
	Copertura dei requisiti obbligatori & Il valore di accettazione stabilito per la metrica è 100 & La misura viene effettuata prendendo in considerazione le informazioni aggiornate nel database di PragmaDB a seguito dell'esecuzione con successo dei relativi test di sistema \\ 
	\hline 
	Distanza dalla sequenza principale normalizzata & Il range di accettazione stabilito per la metrica è 0.0 - 0.7 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Grado di accoppiamento afferente per package & Il range di accettazione stabilito per la metrica è 0 - 39 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Grado di accoppiamento efferente per package & Il range di accettazione stabilito per la metrica è 0 - 16 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Indice di Gulpease & Il range di accettazione stabilito per la metrica è 40 - 100 & La misura viene effettuata utilizzando un apposito script in Perl \\ 
	\hline 
	Instabilità & I range di accettazione stabiliti per la metrica sono 0.0 - 0.4 e 0.6 - 1.0 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di campi dati per classe & Il range di accettazione stabilito per la metrica è 0 - 20 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di figli diretti & Il range di accettazione stabilito per la metrica è 0 - 4 & La misura viene effettuata utilizzando SDMetrics per la progettazione e CodePro Analytix per la codifica \\ 
	\hline 
	Numero di linee di codice per metodo & Il range di accettazione stabilito per la metrica è 0 - 40 & La misura viene effettuata utilizzando lo strumento CodePro Analytix \\ 
	\hline 
	Numero di metodi per classe & Il range di accettazione stabilito per la metrica è 0 - 20 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di parametri per metodo & Il range di accettazione stabilito per la metrica è 0 - 8 & La misura viene effettuata utilizzando lo strumento CodePro Analytix \\ 
	\hline 
	Numero di tipi per package & Il range di accettazione stabilito per la metrica è 0 - 30 & La misura viene effettuata utilizzando lo strumento CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di violazioni della completezza architetturale di alta importanza & Il valore di accettazione stabilito per la metrica è 0 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni della completezza architetturale di media importanza & Il range di accettazione stabilito per la metrica è 0 - 5 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni della completezza architetturale di bassa importanza & Il range di accettazione stabilito per la metrica è 0 - 10 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni della correttezza architetturale di alta importanza & Il valore di accettazione stabilito per la metrica è 0 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni della correttezza architetturale di media importanza & Il range di accettazione stabilito per la metrica è 0 - 5 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni della correttezza architetturale di bassa importanza & Il range di accettazione stabilito per la metrica è 0 - 10 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni dello stile architetturale di alta importanza & Il valore di accettazione stabilito per la metrica è 0 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni dello stile architetturale di media importanza & Il range di accettazione stabilito per la metrica è 0 - 5 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni dello stile architetturale di bassa importanza & Il range di accettazione stabilito per la metrica è 0 - 10 & La misura viene effettuata utilizzando SDMetrics \\ 
	\hline 
	Numero di violazioni di alta importanza delle norme di codifica & Il valore di accettazione stabilito per la metrica è 0 & La misura viene effettuata utilizzando CodePro Analytix \\ 
	\hline 
	Numero di violazioni di media importanza delle norme di codifica & Il range di accettazione stabilito per la metrica è 0 - 5 & La misura viene effettuata utilizzando CodePro Analytix \\ 
	\hline 
	Numero di violazioni di bassa importanza delle norme di codifica & Il range di accettazione stabilito per la metrica è 0 - 10 & La misura viene effettuata utilizzando CodePro Analytix \\ 
	\hline 
	Percentuale di test di unità eseguiti & Il range di accettazione stabilito per la metrica è 90 - 100 & La misura viene effettuata utilizzando lo strumento Travis CI \\ 
	\hline 
	Percentuale di test di integrazione eseguiti & Il range di accettazione stabilito per la metrica è 90 - 100 & La misura viene effettuata utilizzando lo strumento Travis CI \\ 
	\hline 
	Percentuale di test di sistema eseguiti & Il range di accettazione stabilito per la metrica è 90 - 100 & La misura viene effettuata utilizzando lo strumento Travis CI \\ 
	\hline 
	Percentuale di test di validazione eseguiti & Il range di accettazione stabilito per la metrica è 90 - 100 & La misura viene effettuata utilizzando utilizzando lo strumento Travis CI \\ 
	\hline 
	Percentuale di test superati & Il range di accettazione stabilito per la metrica è 90 - 100 & La misura viene effettuata prendendo in considerazione le informazioni aggiornate nel database di PragmaDB a seguito dell'esecuzione con successo dei relativi test di sistema \\ 
	\hline 
	Percentuale linee di commento su linee di codice & Il range di accettazione stabilito per la metrica è 20 - 40 & La misura viene effettuata utilizzando lo strumento CodePro Analytix \\ 
	\hline 
	Profondità di annidamento dei blocchi & Il range di accettazione stabilito per la metrica è 0 - 8 & La misura viene effettuata utilizzando lo strumento CodePro Analytix \\ 
	\hline 
	Profondità nella gerarchia & Il range di accettazione stabilito per la metrica è 0 - 4 & La misura viene effettuata utilizzando SDMetrics per la progettazione e CodePro Analytix per la codifica \\ 
	\hline 
	Statement Coverage & Il range di accettazione stabilito per la metrica è 80 - 100 & La misura viene effettuata utilizzando lo strumento Travis CI \\ 
	\hline 
	Schedule Variance & Il range di accettazione stabilito per la metrica è -25 - 0 & La misura viene effettuata utilizzando lo strumento Asana \\ 
	\hline 
	Validazione W3C & Il range di accettazione stabilito per la metrica è 0 - 20 & La misura viene effettuata utilizzando il validatore W3C disponibile all'indirizzo \url{validator.w3.org/} \\ 
	\hline 
