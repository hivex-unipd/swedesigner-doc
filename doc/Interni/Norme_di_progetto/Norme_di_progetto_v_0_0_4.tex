...
\subsection{Sviluppo}
	...
	Viene elencata nelle sezioni a seguire la struttura obbligatoria di requisiti e casi d'uso.
		...
		\begin{equation}
			UC[x]
		\end{equation}
		Ogni macro caso d'uso sarà poi analizzato in modo più specifico ed identificato da UC[p].[f] dove p indica il il caso d'uso padre e f il figlio(ogni figlio potrà a sua volta possedere una gerarchia di figli).
	...
	\subsubsection{Strumenti}
		...
		%visto che non specifichiamo ne codifica ne progettazione possiamo ometterlo come i leaf.
