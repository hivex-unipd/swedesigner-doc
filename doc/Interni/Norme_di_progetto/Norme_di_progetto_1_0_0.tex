...
\subsection{Sviluppo}
	...
	\paragraph{Attività} Il lavoro dei progettisti consiste nel progettare il software; nello specifico, questo lavoro si articola in due attività:
	\begin{enumerate}
		\item \textbf{Progettazione architetturale} (attività ISO/IEC 12207 5.3.5) --- definire l'architettura del sistema, cioè individuare e descrivere le componenti del sistema; ogni progettista documenta questa attività nel documento di Specifica Tecnica.
		\item \textbf{Progettazione di dettaglio} (attività ISO/IEC 12207 5.3.6) --- definire, in dettaglio, il \emph{comportamento} delle componenti del sistema; ogni progettista documenta questa attività nel documento di Definizione di Prodotto.
	\end{enumerate}
	...
	\paragraph{Diagrammi} Per descrivere l'architettura e il comportamento del sistema i progettisti utilizzano i diagrammi \gloss{UML} descritti qui di seguito, in riferimento allo standard UML 2.0:
	\begin{itemize}
	...
	\paragraph{Stile di progettazione} \proj{} è un software a oggetti; perciò, le componenti software descritte nei diagrammi delle classi sono classi \gloss{Java} e prototipi di oggetti \gloss{JavaScript}. Per comodità, chiameremo “classi” anche i prototipi di oggetti JavaScript, benché tale linguaggio non offra il costrutto \texttt{class} se non come “zucchero sintattico”. Pertanto, le procedure descritte nei diagrammi delle attività sono:
	\begin{itemize}
	...
	\begin{itemize}
		\item quando una classe si interfaccia con un'altra, essa non deve specificare una particolare classe concreta ma soltanto una suo \emph{tipo}, cioè un'interfaccia o una classe astratta;
		\item ...
		\item 
	\end{itemize}
