...
\subsection{Sviluppo}
	...
	Il compito dei progettisti consiste nel progettare l'architettura del software. % da completare.
%%% >>>>>> DA COMPLETARE <<<<<<
	La fase di progettazione deve utilizzare i diagrammi \gloss{UML} descritti qui di seguito, in riferimento allo standard UML 2.0:
	\begin{itemize}
