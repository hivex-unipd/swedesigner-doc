...
\subsection{Sviluppo}
	...
	Viene elencata nelle sezioni seguenti la struttura obbligatoria di requisiti e casi d'uso.
		...
		\begin{description}
			...
			\begin{itemize}
				...
				\item \textbf{F}: facoltativo. %non ne abbiamo ma credo pragma esporti allo stesso modo sia per noi che per i thefellow
			\end{itemize}
	...
	% \begin{itemize}
		...
		% \item Diagramma dei package: raggruppa un numero di elementi \gloss{UML} in una sola unità di livello più alto.
		% \item \gloss{Diagramma delle attività}: descrive in dettaglio un algoritmo
		% \item Diagramma di sequenza: descrive uno \gloss{scenario}, dove le azioni sono disposte in sequenza e le varie scelte sono già state prese.
	% \end{itemize}
