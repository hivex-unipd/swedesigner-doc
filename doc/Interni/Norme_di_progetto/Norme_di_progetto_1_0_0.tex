...
\begin{itemize}
	...
	\item SDMetrics User Manual: \url{http://www.sdmetrics.com/manual/index.html};
...
\subsection{Sviluppo}
	...
	\subsubsection{Strumenti}
		\paragraph{PragmaDB}
		Per tracciare le relazioni tra casi d'uso e requisiti, il gruppo ha scelto di usare \gloss{PragmaDB} (\url{https://github.com/StefanoMunari/PragmaDB}), software realizzato da studenti degli anni passati.
