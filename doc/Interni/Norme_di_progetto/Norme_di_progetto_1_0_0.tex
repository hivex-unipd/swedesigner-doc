...
\subsection{Sviluppo}
	...
	*/
	\end{equation}
	\item Per documentazione di inizio file in Javascript rispettare sempre la struttura descritta per i file .java al punto sopra.
	...
	\item all'inizio di ogni funzione javascript si inserisce un commento con la struttura descritta in seguito:
	\begin{equation}
	 /** 
