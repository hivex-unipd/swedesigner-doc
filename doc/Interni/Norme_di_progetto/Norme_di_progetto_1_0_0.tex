...
\subsection{Sviluppo}
	...
	\begin{itemize}
		...
		\item la spiegazione di una componente o di un metodo Java deve seguire gli standard di documentazione JavaDoc;
		\item la spiegazione di una componente, di un metodo o di una funzione JavaScript deve seguire le linee guida di jdoc (\url{github.com/jsdoc3/jsdoc});
