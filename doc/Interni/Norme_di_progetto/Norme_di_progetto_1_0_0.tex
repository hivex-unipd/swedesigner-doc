...
\subsection{Sviluppo}
	...
	\subsubsection{Strumenti}
		...
		\paragraph{Astah}
		L'\gloss{editor} \gloss{UML} che gli analisti dovranno usare è \gloss{Astah}, creato da \emph{ChangeVision} e disponibile gratuitamente online. Supporta la generazione di tutti i diagrammi che vengono usati dal gruppo (classi, attività, sequenza e package).
