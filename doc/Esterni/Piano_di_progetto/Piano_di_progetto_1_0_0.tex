...
\begin{longtable}{| p{3cm} | p{3.5cm} | p{4cm} | p{3cm} |}
	...
	rotture hardware & verifica giornaliera del funzionamento dei propri strumenti & sincronizzazione con \gloss{GitHub} al termine di ogni modifica al \gloss{repository} continui backup su dispositivo di memoria esterno; \gloss{backup} automatico settimanale del \gloss{server} su AWS e tempestività dell’\AM{} nel riportare tale macchina in uno stato funzionante nel minor tempo possibile & Analisi dei requisiti: rischio mai verificatosi. \\
