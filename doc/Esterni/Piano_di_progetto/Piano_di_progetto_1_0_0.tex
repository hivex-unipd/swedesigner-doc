...
\begin{longtable}{| p{3cm} | p{3.5cm} | p{4cm} | p{3cm} |}
	...
	rotture hardware & verifica giornaliera del funzionamento dei propri strumenti & sincronizzazione con \gloss{Git}Hub al termine di ogni modifica al \gloss{repository} continui \gloss{backup} su dispositivo di memoria esterno; backup automatico settimanale del server su \gloss{AWS} e tempestività dell’\AM{} nel riportare tale macchina in uno stato funzionante nel minor tempo possibile & Analisi dei requisiti: rischio mai verificatosi. \\
...
\introcosto{\AR}
Questo costo viene fornito a scopo informativo e rappresenta l'investimento effettuato da \hx{} prima dell'aggiudicazione dell'appalto e perciò tale periodo \textbf{non è a carico del \gloss{client}e}. 
...
\label{tab:cgen1}
  ...
  \caption{Variazione rispetto alla pianificazione per fase di \AR, \gloss{diagramma di Gantt}}
\end{figure}
