...
Il progetto \proj, come affrontato nei documenti \SdF{} e \PdQ, presenta numerosi punti critici, analizzati nella sezione \ref{sec:rischi} (in particolare nella sezione \ref{sec:tec}, in cui sono analizzati i rischi tecnologici). \proj{} richiede un'intensiva fase di progettazione, il cui fine ultimo è l'esplorazione delle problematiche legate ai software CASE (Computer Aided Software Engineering) e alla loro realizzazione, tenendo conto del quantitativo di risorse assegnate al progetto. % riferimento a verbale di riunione con zucchetti?
...
La seguente sezione elenca e descrive i possibili rischi che possono andare ad inficiare il lavoro del gruppo. La gestione dei rischi è divisa in cinque sottofasi:
\begin{description}
...
% >>> TODO: mettere tutta la sezione in forma tabulare <<<
% \begin{centering}
% \begin{tabular}{p{3.5cm}|r|r|p{3cm}|p{3.5cm}|p{3.5cm}}
% 	\textbf{Descrizione} & \textbf{Probabilità} & \textbf{Pericolosità} & \textbf{Riconoscimento} & \textbf{Trattamento} & \textbf{Attuaz. nel periodo} \\
% 	\hline
% 	tecnologie & media & alta & supervisione da parte del resp. di progetto. & auto-apprendimento & analisi dei requisiti: il rishio non si è ancora verificato. \\
% 	strumentazione dei membri del gruppo e server del gruppo & bassa & media & verifica autonoma quotidiana & utilizzo di \gloss{GitHub} e backup settimanale del server. & analisi dei requisiti: il rishio non si è mai verificato. \\
% \end{tabular}
% \end{centering}
