...
Note:
\begin{itemize}
\item l'attività \emph{Redazione Analisi dei Requisiti} ha una dipendenza verso l'attività \emph{PragmaDB} appartenente all'attività \emph{Database tracciamento requisiti};
