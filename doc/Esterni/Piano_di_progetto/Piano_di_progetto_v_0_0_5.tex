...
\subsection{Suddivisione delle Attività}
	...
	\textbf{Periodo}: dal xx-02-2017 al 06-03-2017.	
	\\ Questo periodo inizia subito dopo \textit{Analisi dei Requisiti Incrementale} e si conclude con la consegna dei documenti per la 
	\textit{Revisione di Progettazione}.
	La \textit{Progettazione Architetturale} prevede la stesura della progettazione ad alto  livello e predeve lo svolgimento delle seguenti attività:
	\begin{itemize}
	...
	\textbf{Periodo}: dal 07-03-2017 al 11-04-2017.	
	...
	La \textit{Progettazione di Dettaglio e Codifica} prevede la stesura del \textit{Definizione di Prodotto} e successivamente si inizierà
	...
	\textbf{Periodo}: dal 12-04-2017 al 14-05-2017.
	...
	In questo periodo vengono effettuati i test del software, atti a garantire un prodotto finale che soddisfi i requisiti contenuti nell'\textit{Analisi dei Requisiti}.
