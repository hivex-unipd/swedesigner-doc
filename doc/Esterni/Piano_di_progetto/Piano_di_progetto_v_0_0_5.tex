...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.2\textwidth]{img/costoar.png}\par
}
\caption{Caption}
\label{fig:car}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.5\textwidth]{img/oreari1.png}}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.2\textwidth]{img/oreari2.png}}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.5\textwidth]{img/orepa1.png}}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.5\textwidth]{img/orevv1.png}}
