...
\begin{table}[htbp]
	\begin{center}
		...
		\begin{tabular}{|c|c|p{5cm}|}
			...
			\hline
			\LB & 25-12-2016 %& \myincludegraphics{path firma} \\[1ex]
			\hline
		\end{tabular}
	\end{center}
	\caption{Redazione}
...
\begin{table}[htbp]
	\begin{center}
		...
		\begin{tabular}{|c|c|p{5cm}|}
			...
			\hline
			\LB		& 24-01-2017					%& \myincludegraphics{path firma}			\\[1ex]
			\hline
			\TV	&								&			\\[1ex]
			\hline
		\end{tabular}
...
\begin{table}[htbp]
	\begin{center}
		...
		\begin{tabular}{|c|p{3.5cm}|p{6cm}|}
			...
			\hline
			\AZ	&	24-01-2017	%& \myincludegraphics{path firma}	\\[1ex]
			\hline
			\GG		&	24-01-2017	%& \myincludegraphics{path firma}		\\[1ex]
			\hline
			\LB		&	24-01-2017	%& \myincludegraphics{path firma}		\\[1ex]
			\hline
			\LS		&	24-01-2017	%& \myincludegraphics{path firma}		\\[1ex]
			\hline
			\MM		&	24-01-2017	%& \myincludegraphics{path firma}		\\[1ex]
			\hline
			\PB		&	24-01-2017	%& \myincludegraphics{path firma}		\\[1ex]
			\hline
		\end{tabular}
	\end{center}
