...
% Abbiamo presentato al \GP un breve esempio (nella forma di un caso d'uso del sistema), in cui un utente crea un nuovo progetto con la nostra applicazione e si interfaccia con il \gloss{diagramma delle classi} e il \gloss{diagramma di attività}.
