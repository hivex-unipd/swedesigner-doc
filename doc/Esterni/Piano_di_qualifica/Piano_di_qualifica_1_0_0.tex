...
\item selezionare l'opzione di conferma.
\end{itemize} & \textit{Non Implementato}\\ \hline
\hypertarget{TVFO4}{TVFO4} & L'utente intende visualizzare il diagramma delle attività di un particolare metodo.
All'utente è richiesto di:
\begin{itemize}
\item trovarsi nella schermata di gestione del diagramma delle classi del progetto;
\item selezionare una classe;
...
\hypertarget{TI14}{TI14} & Test di integrazione fra le componenti CellType, Collection, Model e View e la libreria esterna JointJS. & \textit{Non Implementato}\\ \hline
