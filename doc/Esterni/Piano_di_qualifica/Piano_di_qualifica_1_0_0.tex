...
reale di fine di quell’attività: un valore di \textit{schedule variance} minore di zero indica che l'attività di progetto considerata sta richiedendo più tempo di quanto pianificato; se pari a zero indica invece che essa è perfettamente in linea con le tempistiche previste mentre se è addirittura strettamente positivo indica che sta procedendo più speditamente di quanto considerato. 
			...
			\paragraph[Produttività di codifica]{\hypertarget{pdc}{Produttività di codifica}}
			...
			\paragraph[Test di unità eseguiti]{\hypertarget{tde}{Test di unità eseguiti}}
	...
	\subsection{Metriche per il prodotto}
		...
		Il gruppo \hx{} ha deciso di seguire metriche relative all'efficienza del software riguardanti taluni vincoli che il codice deve rispettare.
			...
			\paragraph[Numero di porzioni di codice duplicate]{\hypertarget{npcd}{Numero di porzioni di codice duplicate}}
		...
		Per garantire un elevato grado di manutenibilità, si è deciso di adottare un discreto numero di metriche che spaziano su diversi aspetti del programma.
			...
			\paragraph[]{\hypertarget{vw}{Validazione W3C}}
	...
	\hline
	~~\hyperlink{sv}{Schedule variance} 							&$\geq{-10}$\%	&$\geq{0}$\\
	~~\hyperlink{bv}{Budget variance} 								&$\geq{-10}$\%	&$\geq{0}$\\
	~~\hyperlink{pc}{Produttività di codifica} 						&$\geq{10}$		&$\geq{3}$\\
	...
	~~\hyperlink{tda}{Test di accettazione eseguiti}					&90-100			&100-100\\
	~~\hyperlink{ig}{Indice Gulpease}								&40-100			&50-100\\
	...
	~~\hyperlink{pa}{Profondità annidamento}						&0-10			&0-4\\
	~~\hyperlink{npcd}{Numero di porzioni di codice duplicate}					&-			&-\\
	~~\hyperlink{msm}{Numero di statement per metodo}				&0-50			&0-20\\
	~~\hyperlink{npm}{Numero di parametri per metodo}				&0-10			&0-4\\
	~~\hyperlink{mcdc}{Numero di campi dati per classe}				&0-20			&0-10\\
	~~\hyperlink{nmc}{Numero di metodi per classe}					&0-30			&0-15\\
	~~\hyperlink{ga}{Gradi di accoppiamento}						&0-7			&0-3\\
	~~\hyperlink{cci}{Complessità ciclomatica}						&1-15			&1-10\\
	~~\hyperlink{lmu}{Lunghezza media di un'unità}					&100-500		&100-300\\
	~~\hyperlink{fo}{Fan-in}										&0-20			&0-5\\
	~~\hyperlink{fi}{Fan-out}										&0-20			&0-5\\
