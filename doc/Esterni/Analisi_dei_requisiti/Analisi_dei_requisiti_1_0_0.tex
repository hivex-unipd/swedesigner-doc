...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: l'attore può ottenere (scaricare) automaticamente una cartella compressa contenente l'applicativo generato dall'editor grazie ai diagrammi forniti e realizzati dall'utente, i diagrammi stessi ed il codice sorgente in linguaggio target;
	...
	\item \textbf{Postcondizione}: il sistema viusalizza la cartella compressa scaricata dall'utente;
