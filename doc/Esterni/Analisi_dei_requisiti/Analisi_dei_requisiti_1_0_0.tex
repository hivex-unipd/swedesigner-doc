...
\section{Descrizione generale}
	...
	\begin{itemize}
		...
		\item Le astrazioni e i paradigmi della programmazione orientata agli oggetti; infatti il linguaggio target di generazione del codice, i diagrammi e le funzionalità offerte suggeriscono che l'architettura dell'applicativo da realizzarsi sia ben strutturata in moduli funzionali specifici e distinti.
	\end{itemize}
...
\subsection{UC4: Realizzazione \gloss{Diagramma Delle Classi}}
\label{UC4}
\myimgsmall{UC4 - Realizzazione \gloss{Diagramma delle Classi}}
...
\item \textbf{Precondizione}: il sistema visualizza il form per l'inserimento dei dati;	
\item \textbf{Postcondizione}: il sistema visualizza la classe inserita nella porzione dell'editor dedicata alla gestione e realizzazione del \gloss{diagramma delle classi}; 
\item \textbf{Scenario principale}:
...
\item \textbf{Precondizione}: il sistema visualizza le classi fornite dall'attore nella sezione dell'editor dedicata alla gestione e realizzazione del \gloss{diagramma delle classi};
...
\item \textbf{Precondizione}: il sistema visualizza la struttura di classi realizzata dall'attore nella sezione dell'editor dedicata alla gestione del \gloss{diagramma delle classi};
...
\subsection{UC5: Realizzazione \gloss{Diagramma delle Attività}}
\label{UC5}
...
\item \textbf{Precondizione}: il sistema è passato dalla sezione dell'editor dedicata alla gestione del \gloss{diagramma delle classi} alla sezione dell'editor dedicata alla gestione del \gloss{diagramma delle attività} del metodo selezionato;	
...
\item \textbf{Precondizione}: il sistema, nella sezione dell'editor dedicata alla gestione del \gloss{diagramma delle attività}, visualizza un \gloss{diagramma delle attività} (eventualmente vuoto) associato ad un particolare metodo;
