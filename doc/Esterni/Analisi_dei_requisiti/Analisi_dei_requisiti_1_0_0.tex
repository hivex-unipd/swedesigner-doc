...
\begin{itemize}
	\item Le principali convenzioni della modellazione \gloss{UML} e, nello specifico, i diagrammi delle classi e i diagrammi delle attività.
...
Il prodotto sviluppato risulterà fruibile da qualsiasi piattaforma desktop con operante un browser web compatibile con le tecnologie \gloss{HTML}5, \gloss{CSS}3 e \gloss{Java}Script. In particolare, l'elenco dei browser il cui supporto è garantito è contenuto nella sezione \ref{sec:reqvincolo} relativa ai requisiti di vincolo.
...
\begin{itemize}
	...
	\item \textbf{Scenario principale}:
	\begin{itemize} % >>> disegno con \gloss{Astah}? UC3.1 <<<
...
%		\item l'attore non ha inserito il tipo dell'attributo; % Ho inserito il tipo predefinito (Object) come \gloss{scenario} alt. in UC4.1.4.3
...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: l'attore può ottenere (scaricare) automaticamente un file .jar contenente l'applicativo generato dai diagrammi da esso forniti e realizzati mediante l'editor, i diagrammi stessi ed il codice sorgente in linguaggio target;
...
\hypertarget{RVO1.1}{RVO1.1} & l'applicativo lato \gloss{client} è realizzato in \gloss{HTML5}, CSS e Javascript. & \hyperlink{Capitolato}{Capitolato}\\ \hline
...
\hypertarget{RVO2}{RVO2} & il progetto deve essere sviluppato sulla piattaforma \gloss{Git}Hub in modalità pubblica & \hyperlink{Capitolato}{Capitolato}\\ \hline
