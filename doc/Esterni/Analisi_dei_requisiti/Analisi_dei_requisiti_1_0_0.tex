...
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: l'attore può ottenere (scaricare) automaticamente l'applicativo generato dai diagrammi da esso forniti e realizzati mediante l'\gloss{editor}, i diagrammi stessi ed il codice sorgente in linguaggio \gloss{Java} ;
	...
	\item \textbf{Scenario principale}: l'attore scarica tre file quali l'applicativo, i diagrammi da lui realizzati ed il codice sorgente;
