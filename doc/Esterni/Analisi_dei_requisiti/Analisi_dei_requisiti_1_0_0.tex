...
\begin{itemize}
	...
	\item Capitolato d'appalto C6, \proj: \url{http://www.math.unipd.it/~tullio/IS-1/2016/Progetto/C6.pdf}.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione}: il sistema ha ricevuto il dato richiesto;
	\item \textbf{Scenario principale}: l'attore deve inserire il contenuto in codice del blocco custom in \gloss{Java}, il linguaggio target di generazione del codice dell'applicativo.
\end{itemize}
