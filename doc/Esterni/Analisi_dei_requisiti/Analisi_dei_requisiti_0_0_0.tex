...
\begin{itemize}
\item \textbf{Attori}: Utente;
\item \textbf{Descrizione}: l'attore può inserire la condizione da verificare del blocco if;	
...
\hline
\endhead
\hypertarget{RFO1}{RFO1} & l'attore può caricare un progetto & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO2}{RFO2} & l'attore può creare un nuovo progetto & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3}{RFO3} & l'attore può realizzare e gestire un diagramma delle classi & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1}{RFO3.1} & l'attore può inserire una classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.1}{RFO3.1.1} & l'attore può inserire la visibilità della classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.2}{RFO3.1.2} & l'attore può inserire il nome della classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.3}{RFO3.1.3} & l'attore può scegliere uno stereotipo per la classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4}{RFO3.1.4} & l'attore può inserire un attributo per la classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.1}{RFO3.1.4.1} & l'attore può scegliere la visibilità per l'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.2}{RFO3.1.4.2} & l'attore può inserire il nome dell'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.3}{RFO3.1.4.3} & l'attore può inserire il tipo dell'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.4}{RFO3.1.4.4} & l'attore può scegliere la molteplicità dell'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.5}{RFO3.1.4.5} & l'attore può inserire il valore di default dell'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.6}{RFO3.1.4.6} & l’attore può confermare l'inserimento dell'attributo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.4.6.1}{RFO3.1.4.6.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha inserito il nome dell'attributo, non ha inserito il tipo dell'attributo o ha inserito un nome per l'attributo già esistente & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.5}{RFO3.1.5} & l'attore può rimuovere un attributo precedentemente inserito & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6}{RFO3.1.6} & l'attore può inserire un metodo per la classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.1}{RFO3.1.6.1} & l'attore può scegliere la visibilità per il metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.2}{RFO3.1.6.2} & l'attore può inserire il nome del metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.3}{RFO3.1.6.3} & l'attore può inserire un parametro per il metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.3.1}{RFO3.1.6.3.1} & l'attore può inserire il parametro del metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.3.2}{RFO3.1.6.3.2} & l'attore può inserire il tipo del metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.3.3}{RFO3.1.6.3.3} & l’attore può confermare l'inserimento del parametro & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.3.3.1}{RFO3.1.6.3.3.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha inserito il nome del parametro o non ha inserito il tipo del parametro & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.4}{RFO3.1.6.4} & l'attore può inserire il tipo di ritorno del metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.5}{RFO3.1.6.5} & l’attore può confermare l'inserimento del metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.6.5.1}{RFO3.1.6.5.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha inserito il nome del metodo, non ha inserito il tipo di ritorno del metodo o ha inserito un metodo con una segnatura già esistente & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.7}{RFO3.1.7} & l'attore può rimuovere un metodo precedentemente inserito & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.8}{RFO3.1.8} & l’attore può confermare l'inserimento della classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.1.8.1}{RFO3.1.8.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha inserito il nome della classe o ha inserito un nome per la classe già esistente & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2}{RFO3.2} & l'attore può inserire una relazione tra due classi & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.1}{RFO3.2.1} & l'attore può scegliere il nome della relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.2}{RFO3.2.2} & l'attore può scegliere la classe di partenza per la relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.2.1}{RFO3.2.2.1} & l'attore può rimuovere un commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.3}{RFO3.2.3} & l'attore può scegliere la classe di destinazione per la relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.4}{RFO3.2.4} & l'attore può scegliere la cardinalità della relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.5}{RFO3.2.5} & l'attore può scegliere uno stereotipo per la relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.6}{RFO3.2.6} & l’attore può confermare l'inserimento della relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.2.6.1}{RFO3.2.6.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha scelto la relazione, on ha scelto la di partenza o non ha scelto la classe di destinazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.3}{RFO3.3} & l'attore può inserire un commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.3.1}{RFO3.3.1} & l'attore può inserire il testo del commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.3.2}{RFO3.3.2} & l'attore può scegliere il "parent" del commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.3.3}{RFO3.3.3} & l’attore può confermare l'inserimento del commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.3.3.1}{RFO3.3.3.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha scelto il "parent" del commento. & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.4}{RFO3.4} & l'attore può rimuovere una classe & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO3.5}{RFO3.5} & l'attore può rimuovere una relazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4}{RFO4} & l'attore può realizzare e gestire un diagramma delle attività per ogni metodo presente nel diagramma delle classi & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1}{RFO4.1} & l'attore può inserire un blocco variabile scegliendo tra inizializzazione e assegnazione & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1.1}{RFO4.1.1} & l'attore può creare ed inizializzare una variabile assegnandole un valore & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1.2}{RFO4.1.2} & l'attore può assegnare un valore ad una variabile esistente e visibile & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1.3}{RFO4.1.3} & l’attore può inserire un commento per il blocco variabile & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1.4}{RFO4.1.4} & l’attore può confermare l'inserimento del blocco variabile & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.1.4.1}{RFO4.1.4.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha fornito la variabile da inizializzare, non ha fornito un valore da assegnare alla variabile o non ha inserito un commento. & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.2}{RFO4.2} & l'attore può inserire un blocco metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.2.1}{RFO4.2.1} & l'attore può invocare un metodo tra quelli disponibili & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.2.2}{RFO4.2.2} & l’attore può inserire un commento per il blocco metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.2.3}{RFO4.2.3} & l’attore può confermare l'inserimento del blocco metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.2.3.1}{RFO4.2.3.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha fornito un metodo da inserire o non ha inserito un commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3}{RFO4.3} & l'attore può inserire un blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.1}{RFO4.3.1} & l'attore può inserire la condizione da verificare del blocco if & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.2}{RFO4.3.2} & l'attore può completare il corpo del blocco if, inserendo una serie di blocchi tra quelli resi disponibili dall'editor  & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.3}{RFO4.3.3} & l'attore può completare il corpo del blocco else, inserendo una serie di blocchi tra quelli resi disponibili dall'editor  & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.4}{RFO4.3.4} & l’attore deve inserire un commento per il blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.5}{RFO4.3.5} & l’attore può confermare l'inserimento del blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.3.5.1}{RFO4.3.5.1} & il sistema visualizza un messaggio d’errore se l'attore non ha fornito la condizione da verificare o non ha inserito un commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4}{RFO4.4} & l'attore può inserire un blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4.1}{RFO4.4.1} & l'attore può inserire la condizione da verificare del blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4.2}{RFO4.4.2} & l'attore può completare il corpo del blocco while, inserendo una serie di blocchi tra quelli resi disponibili dall'editor & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4.3}{RFO4.4.3} & l’attore può inserire un commento per il blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4.4}{RFO4.4.4} & l’attore può confermare l'inserimento del blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.4.4.1}{RFO4.4.4.1} & il sistema deve visualizzare un messaggio d’errore se l'attore non ha fornito la condizione da verificare o non ha inserito un commento. & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5}{RFO4.5} & l'attore può inserire un blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.1}{RFO4.5.1} & l'attore può inserire l'inizializzazione del blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.2}{RFO4.5.2} & l'attore può inserire la condizione da verificare del blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.3}{RFO4.5.3} & l'attore può inserire l'incremento/decremento del blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.4}{RFO4.5.4} & l'attore può completare il corpo del blocco for, inserendo una serie di blocchi tra quelli resi disponibili dall'editor & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.5}{RFO4.5.5} & l’attore può inserire un commento per il blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.6}{RFO4.5.6} & l’attore può confermare l'inserimento del blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.5.6.1}{RFO4.5.6.1} & il sistema deve visualizzare un messaggio d'errore se l'attore non ha fornito la condizione da verificare, non ha fornito l'incremento/decremento o non ha inserito un commento & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.6}{RFO4.6} & l'attore può inserire un blocco custom di codice & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.6.1}{RFO4.6.1} & l'attore può inserire il contenuto del blocco custom & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.6.2}{RFO4.6.2} & l’attore può inserire un commento per il blocco custom & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.6.3}{RFO4.6.3} & l’attore può confermare l'inserimento del blocco custom & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.7}{RFO4.7} & l'attore può rimuovere un blocco variabile & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.8}{RFO4.8} & l'attore può rimuovere un blocco metodo & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.9}{RFO4.9} & l'attore può rimuovere un blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.10}{RFO4.10} & l'attore può rimuovere un blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.11}{RFO4.11} & l'attore può rimuovere un blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO4.12}{RFO4.12} & l'attore può rimuovere un blocco custom & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.13}{RFD4.13} & l'attore può ridurre il blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.14}{RFD4.14} & l'attore può espandere il blocco if/else & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.15}{RFD4.15} & l'attore può ridurre il blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.16}{RFD4.16} & l'attore può espandere il blocco while & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.17}{RFD4.17} & l'attore può ridurre il blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFD4.18}{RFD4.18} & l'attore può espandere il blocco for & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO5}{RFO5} & l'attore può salvare il progetto & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline

\hypertarget{RFO6}{RFO6} & l'attore può generare l'applicativo dai diagrammi da lui realizzati & \textcolor{red}{\textit{Non Soddisfatto}}\\ \hline
