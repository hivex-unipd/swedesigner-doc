...
Si noti che è possibile, per esigenze tipografiche, che certe figure siano state posizionate immediatamente dopo l'intera esposizione del caso d'uso. Esse sono comunque rintracciabili dal loro identificatore univoco.
