...
\section{Descrizione generale}
	...
	Il progetto sviluppato consiste nella creazione di un applicativo web che possa permettere la creazione di svariati software di un determinato dominio applicativo (i giochi da tavolo). In dettaglio, sarà possibile:
	\begin{itemize}
