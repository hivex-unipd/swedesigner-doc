...
\item \textbf{Descrizione}: l'atl'attore ha selezionato il blocco metodo da modificare e il sistema visualizza il form di inserimento dati ;	
...
\hypertarget{RFD4.20.1}{RFD4.20.1} & l'attore può modificare il nome del blocco variabile &  \hyperlink{Interno}{Interno}\\
