...
\begin{longtable}{|p{0.5\textwidth}|p{0.2\textwidth}|p{0.3\textwidth}|}
	...
	\hline 
	Distanza dalla sequenza principale normalizzata &  0.0 - 0.7 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Grado di accoppiamento afferente per package &  0 - 39 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Grado di accoppiamento efferente per package &  0 - 16 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Indice di Gulpease &  40 - 100 & Script in Perl \\ 
	\hline 
	Instabilità &  0.0 - 0.4 e 0.6 - 1.0 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di campi dati per classe &  0 - 20 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di figli diretti &  0 - 4 &  SDMetrics per la progettazione e CodePro Analytix per la codifica \\ 
	\hline 
	Numero di linee di codice per metodo &  0 - 40 &  CodePro Analytix \\ 
	\hline 
	Numero di metodi per classe &  0 - 20 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	Numero di parametri per metodo &  0 - 8 &  CodePro Analytix \\ 
	\hline 
	Numero di tipi per package &  0 - 30 &  CodePro Analytix per la codifica e SDMetrics per la progettazione \\ 
	\hline 
	...
	\hline 
	Profondità nella gerarchia &  0 - 4 &  SDMetrics per la progettazione e CodePro Analytix per la codifica \\ 
	\hline 
	Statement Coverage &  80 - 100 &  Travis CI \\ 
	\hline 
	Schedule Variance &  -25 - 0 &  Asana \\ 
	\hline 
	Validazione W3C &  0 - 20 &  Il validatore W3C disponibile all'indirizzo \url{validator.w3.org/} \\ 
	\hline 
