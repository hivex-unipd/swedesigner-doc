...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Studio di fattibilità del capitolato scelto
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Studio di fattibilità del capitolato scelto}
	\subsection{\proj: editor di diagrammi UML con generazione di codice}
		...
		\subsubsection{Studio del dominio}
			...
			\gloss{Tomcat} o in JavaScript con il server \gloss{Node.js}. La parte \gloss{client}, invece, deve essere eseguibile in un browser HTML5 ed utilizzare fogli di stile CSS3 per l'aspetto estetico e JavaScript per la parte attiva.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Studio di fattibilità degli altri capitolati
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
