...
\item Si riportano le tabelle di divisione oraria effettive e i relativi costi.
\item  \textbf{Nota}: le variazioni tra parentesi si riferiscono all'ultimo preventivo a finire presentato.
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.1\textwidth]{img/final/orevv.png}}
\label{tab:cgen1}

  \caption{Ore a consuntivo {\VV} per ruolo e per persona, valori in ore.}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.1\textwidth]{img/final/costovv.png}}
\label{tab:cgen1}

  \caption{Costo a consuntivo {\VV} per ruolo e per persona, valori in euro (\euro).}
\end{figure}
\pagebreak
...
Il nuovo preventivo a finire precedentemente presentato è stato rispettato in pieno: al fine di conseguire la maggior qualità possibile con le risorse a disposizione è stato deciso di incrementare di 6 ore le attività preventivate per la verifica.

A seguito della riunione esterna del 04-05-2017, nel quale è stato presentato al \GP{} il lavoro fino ad allora svolto, il team è riuscito a presentare un prodotto che è riuscito a soddisfare appieno le richieste e i desideri del cliente. Sono stati raccolti consigli su come raffinare il prodotto finale sfruttando il budget aumentato per le ore di \Vx.
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.2\textwidth]{img/final/oretotali.png}}
\label{tab:cgen1}

  \caption{Ore a consuntivo totali per ruolo e per persona, valori in ore.}
\end{figure}
...
\begin{figure}[H]
\makebox[\textwidth][c]{
\includegraphics[width=1.2\textwidth]{img/final/costototale.png}}
\label{tab:cgen1}

  \caption{Costo a consuntivo totale per ruolo e per persona, valori in euro (\euro).}
\end{figure}
