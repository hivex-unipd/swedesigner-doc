...
\begin{itemize}
	\item \click{Variable} dichiara e/o inizializza una nuova variabile, oppure esegue un'operazione su una variabile (assegnazione o chiamata di metodo);
	\item \click{If} esegue una sequenza di blocchi solo se vale una condizione.
	\item \click{Else} esegue una sequenza di blocchi solo se non vale la condizione di un blocco \click{If} immediatamente precedente;
	...
	\item \click{Custom} permette di inserire manualmente del codice che verrà copiato direttamente nel codice sorgente.
\end{itemize}
