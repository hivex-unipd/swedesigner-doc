...
% da compilare con il comando pdflatex Analisi_dei_requisiti_x_x_x.tex
...
\label{UC4.1}
\myimg{UC4.1 - Inserimento BloccoClasse}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.1.2}
\myimgsmall{UC4.1.2 - Inserimento Metodo BloccoClasse}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.1.2.3}
\myimgsmall{UC4.1.2.3 - Inseriento Parametro Metodo}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.2}
\myimgsmall{UC4.2 - Inserimento Classe}
\begin{itemize}
	\item \textbf{Attori}: Utente;
	\item \textbf{Descrizione}: l'attore inserisce i dati di una classe;
	\item \textbf{Precondizione}: il sistema è avviato, mostra il contenuto di un particolare progetto ed è nell'area per la realizzazione e gestione del diagramma delle classi. Viene visualizzata la classe;
...
\label{UC4.2.1}
\myimgsmall{UC4.2.1 - Inserimento Attributo Classe}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.2.5}
\myimgsmall{UC4.2.5 - Inserimento Dati Aggiuntivi Metodo}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\subparagraph{UC4.2.6: Specifica Classe Astratta}
\label{UC4.2.6}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.5}
\myimgsmall{UC4.5 - Inserimento Associazione}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.8}
\myimgsmall{UC4.8 - Inserimento Commento}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.12}
\myimg{UC4.12 - Modifica BloccoClasse}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.12.2}
\myimgsmall{UC4.12.2 - Modifica Metodo BloccoClasse}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.12.2.3}
\myimgsmall{UC4.12.2.3 - Modifica Parametro Metodo}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.13}
\myimgsmall{UC4.13 - Modifica Classe}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.13.1}
\myimgsmall{UC4.13.1 - Modifica Attributo Classe}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.13.2}
\myimgsmall{UC4.13.2 - Modifica Dati Aggiuntivi Metodo}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.14}
\myimgsmall{UC4.14 - Modifica BloccoRelazione}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.15}
\myimgsmall{UC4.15 - Modifica Associazione}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC4.16}
\myimgsmall{UC4.16 - Modifica Commento}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.1}
\myimgsmall{UC5.1 - Inserimento Blocco Variabile}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.2}
\myimgsmall{UC5.2 - Inserimento Blocco If}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.3}
\myimgsmall{UC5.3 - Inserimento Blocco Else}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.4}
\myimgsmall{UC5.4 - Inserimento Blocco While}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.5}
\myimgsmall{UC5.5 - Inserimento Blocco For}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.6}
\myimgsmall{UC5.6 - Inserimento Blocco Custom}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.27}
\myimgsmall{UC5.27 - Modifica Blocco Variabile}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.28}
\myimgsmall{UC5.28 - Modifica Blocco If}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.29}
\myimgsmall{UC5.29 - Modifica Blocco Else}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.30}
\myimgsmall{UC5.30 - Modifica Blocco While}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.31}
\myimgsmall{UC5.31 - Modifica Blocco For}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\label{UC5.32}
\myimgsmall{UC5.32 - Modifica Blocco Custom}
\begin{itemize}
	\item \textbf{Attori}: Utente;
...
\hypertarget{RFO3.17}{RFO3.17} & l'attore può inserire una classe stereotipata &  \hyperlink{Riunione Esterna}{Riunione Esterna}\\
& &\hyperref[UC4]{UC4}\\
...
\hypertarget{RQF1.3}{RQF1.3} & il manuale utente è fornito in lingua italiana & \hyperlink{Interno}{Interno}\\ \hline

\hypertarget{RQO1.4}{RQO1.4} & il manuale utente è fornito in lingua inglese & \hyperlink{Interno}{Interno}\\ \hline
...
\hyperlink{RFO3.17}{RFO3.17} &   \hyperlink{Riunione Esterna}{Riunione Esterna}\\ &\hyperref[UC4]{UC4}\\ &\hyperref[UC4.17]{UC4.17}\\ \hline
...
\hyperlink{RQF1.3}{RQF1.3} &  \hyperlink{Interno}{Interno}\\ \hline
