...
\paragraph{Progettazione del software}
...
\end{center}
		 ...
		 % 		\begin{itemize}
			% 		\item \textbf{indice di Gulpease}: l'obiettivo stabilito per la metrica è l'intervallo $[60, 100]$.
			% 	\end{itemize}

			% \paragraph{Processo di progettazione del software}
		 ...
		 % 		\begin{itemize}
			...
			% 	\end{itemize}
			% 	\subparagraph{Stile}
			% 	L'architettura prodotta non presenta problemi di design che, pur essendo legali per lo standard UML, possano compromettere la qualità generale del sistema. (Ad esempio si evitano dipendenze circolari tra i pacchetti, lunghe liste di parametri, ecc.)
		 ...
		 % 		\begin{itemize}
			...
			% 	Durante il processo di codifica vengono rispettate le norme stabilite nel documento \NdP.
		...
		Gli obiettivi di qualità del software che il gruppo \hx{} desidera raggiungere nell'arco del progetto sono un sottoinsieme di quelli enunciati nello standard ISO/IEC 9126:2001.
			...
			\end{itemize}
		 	...
		 	\begin{itemize}
				...
				\item \textbf{Distanza dalla sequenza principale normalizzata}: l'obiettivo stabilito per la metrica è l'intervallo $[0.0, 0.5]$; 
				\item \textbf{Instabilità}: l'obiettivo stabilito per la metrica sono gli intervalli $[0.0, 0.3]$ e $[0.7, 1.0]$; 
