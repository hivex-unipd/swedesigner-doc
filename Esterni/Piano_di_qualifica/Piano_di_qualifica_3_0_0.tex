...
\hypertarget{TU64}{TU64} & Un \texttt{RequestHandlerController} è in grado di rispondere a una richiesta \texttt{handleGeneratorRequest} senza lanciare eccezioni. & \textcolor{Green}{\textit{Superato}}\\ \hline
