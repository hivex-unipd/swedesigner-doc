...
\subsection{Revisione di qualifica}
		...
		** l'alto valore del numero di violazione di media importanza relative allo stile è dovuto al fatto che nel server in alcune occasioni viene violato lo Stable-Dependencies Principle perchè alcuni package dipendono da altri package contenenti una singola classe concreta. Basta quindi che i primi abbiano una singola interfaccia affinchè la violazione venga segnalata.
		...
		\hline
		Numero violazioni della completezza architetturale di alta importanza &0 &0 &\\
		\hline
		Numero violazioni della completezza architetturale di media importanza &0-5 &0 &\\
		\hline
		Numero violazioni della completezza architetturale di bassa importanza &0-10 &0 &\\
		\hline
		Numero violazioni della correttezza architetturale di alta importanza &0 &0 &\\
		\hline
		Numero violazioni della correttezza architetturale di media importanza &0-5 &0 &\\
		\hline
		Numero violazioni della correttezza architetturale di bassa importanza &0-10 &0 &\\
		\hline
		Numero violazioni dello stile architetturale di alta importanza &0 &0 &\\
		\hline
		Numero violazioni dello stile architetturale di media importanza &0-5 &0 &\\
		\hline
		Numero violazioni dello stile architetturale di bassa importanza &0-10 &0 &\\
		\hline
		Profondita della gerarchia &0-4 &0 &\\
	...
	*** l'unico package contenente un numero di tipi al di fuori del range di accetazione è il package client.model.
