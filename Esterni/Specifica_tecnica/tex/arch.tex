...
Il \emph{back end} della nostra applicazione \`e un server Tomcat che esegue un'applicazione Java e basata sul framework \emph{Spring Boot}. L'applicazione Java \`e contenuta in se stessa e quindi monolitica; questa scelta ci \`e parsa naturale per i seguenti motivi:
\begin{itemize}
	...
	\item un server monolitico era la scelta pi\`u semplice che si potesse fare.
\end{itemize}
