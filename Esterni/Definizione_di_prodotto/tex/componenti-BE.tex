...
\begin{itemize}
\item \nogloxy{\texttt{name: String}}
\\ Indica il nome del supertipo della classe che deve essere implementata o estesa.
\item \nogloxy{\texttt{type: String}}
...
\begin{itemize}
\item \nogloxy{\texttt{name: String}}
\\ Rappresenta il nome di un particolare oggetto ParsedClass.
\item \nogloxy{\texttt{isAbstract: boolean}}
\\ Indica se l'oggetto ParsedClass è astratto o meno.
\end{itemize}
\item \nogloxy{\texttt{+ renderTemplate(template: Template): String}}
...
\item \nogloxy{\texttt{+ ParsedElse(body: List<ParsedInstruction>)}}
\\ Costruisce un oggetto ParsedElse.
\\ \textbf{Parametri}:
\begin{itemize}
\item \nogloxy{\texttt{body: List<ParsedInstruction>}}
\\ Indica l'insieme di istruzioni da inserire nel corpo del corrispondente oggetto ParsedElse.
\end{itemize}
\item \nogloxy{\texttt{+ renderTemplate(template: Template): String}}
...
\\ Inserisce nel campo dati body del ParsedElse un insieme di ParsedInstruction, ossia inserisce il corpo all'interno del body dell'istruzione \emph{if}.
\\ \textbf{Parametri}:
\begin{itemize}
\item \nogloxy{\texttt{parsedInstructions: List<ParsedInstruction>}}
\\ Rappresenta l'insieme di istruzioni da inserire nel campo dati body.
\end{itemize}
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item \nogloxy{\texttt{init: String}}
\\ Rappresenta l'istruzione di inizializzazione di un particolare oggetto ParsedFor.
\item \nogloxy{\texttt{condition: String}}
\\ Rappresenta la condizione del corrispondente oggetto ParsedFor.

\item \nogloxy{\texttt{step: String}}
\\ Rapprensenta il passo di incremento o decremento del corrispondente oggetto ParsedFor.
\end{itemize}
\item \nogloxy{\texttt{+ renderTemplate(template: Template): String}}
